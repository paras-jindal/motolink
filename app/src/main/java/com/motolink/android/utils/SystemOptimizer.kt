...
class SystemOptimizer(private val context: Context) {
    ...
    fun checkH265HardwareSupport(): Boolean {
        return com.motolink.android.decoder.video.VideoDecoder.isHevcSupported()
    }
    ...
    companion object {
        ...
        fun recommendedResolution(realWidthPx: Int, realHeightPx: Int): Settings.Resolution =
            panelCeiling(realWidthPx, realHeightPx, com.motolink.android.decoder.video.VideoDecoder.isHevcSupported())
    }
}
