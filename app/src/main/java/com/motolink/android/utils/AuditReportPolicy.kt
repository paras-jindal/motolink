 ...
 *
 * Written for a [com.motolink.android.aap.FragmentedMessageAudit] outcome, which is the case the rest of this describes, and
 * since reused for [com.motolink.android.aap.AapTransport]'s held-cycle line - a check that repeats every two seconds and can
