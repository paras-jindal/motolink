...
import com.motolink.android.aap.VehicleTypePolicy
import com.motolink.android.aap.protocol.proto.Control
import com.motolink.android.app.UsbAttachedActivity
import com.motolink.android.connection.usb.UsbBlacklistPolicy
import com.motolink.android.connection.usb.UsbDeviceCompat
import com.motolink.android.connection.wifi.direct.ObservedP2pGroup
import com.motolink.android.connection.wifi.direct.StoredP2pIdentity
...
class Settings(private val context: Context) {
    ...
    /**
     * Where captured logs come from. Read on every [com.motolink.android.utils.AppLog.init],
     ...
     * [com.motolink.android.connection.wifi.direct.NativeGroupBandPolicy], which is where that coupling lives.
     *
     ...
     * [com.motolink.android.aap.P2pOperatingChannelPolicy]. Pre-Q also cannot read a group's
     ...
     * [com.motolink.android.connection.wifi.FiveGhzChannelPolicy].
     *
     ...
     * [com.motolink.android.utils.DummyVpnPolicy.shouldStartForSession], which explains why
     ...
     * [com.motolink.android.connection.wifi.direct.StationStandDownMode] value. A user who
     ...
     * See [com.motolink.android.connection.wifi.direct.P2pGroupIdentityPolicy].
     */
     ...
     * [com.motolink.android.decoder.video.DecoderConfigLadder].
     */
    ...
    var geofenceLocations: List<com.motolink.android.location.GeofenceLocation>
        get() = com.motolink.android.location.GeofenceLocation.listFromJson(
            prefs.getString("geofence-locations", "[]")
        )
        set(value) {
            val json = com.motolink.android.location.GeofenceLocation.listToJson(value)
    ...
    companion object {
        ...
        /** SharedPreferences key; also used by [com.motolink.android.aap.AapService] for change listener. */
         ...
         * [com.motolink.android.app.BootCompleteReceiver] on a device that has just booted.
         */
