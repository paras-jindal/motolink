 ...
 *
 * The VPN used to be stopped from the last line of [com.motolink.android.aap.AapService.stopWirelessServer], which
 * [com.motolink.android.aap.AapService.initWifiMode] calls on every mode change. A user reported the VPN icon vanishing on
...
object DummyVpnPolicy {
    ...
    enum class Owner {
        ...
        /** [com.motolink.android.utils.Settings.keepDummyVpnDuringSession]: up for one session. */
        SESSION,
    }
