 ...
 * [com.motolink.android.connection.wifi.modes.nativeaa.NativeAaHandshakeManager] and
 * [com.motolink.android.connection.wifi.direct.WifiDirectManager] share one definition instead of
 * re-deriving it.
 */
object NativeHandoffPolicy {
     ...
     *  ([com.motolink.android.connection.wifi.modes.nativeaa.WppAction.ExtendSettle]) have extended it. Without a cap,
