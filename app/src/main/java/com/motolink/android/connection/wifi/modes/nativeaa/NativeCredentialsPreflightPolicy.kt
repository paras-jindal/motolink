...
data class PreflightProbe(
    /** [com.motolink.android.utils.Settings.hotspotSsid], "" when unset. */
    val manualSsid: String,
    /** [com.motolink.android.utils.Settings.hotspotPassword], "" when unset. */
    val manualPassword: String,
    /** [com.motolink.android.utils.Settings.staticBSSID] verbatim, which is "0" when unset. */
 ...
 *   ([com.motolink.android.connection.WifiDirectManager] reads them back off `WifiP2pGroup`),
