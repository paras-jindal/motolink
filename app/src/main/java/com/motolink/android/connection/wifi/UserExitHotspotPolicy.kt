 ...
 * making the network go away — which is exactly what [com.motolink.android.aap.AapService] already does for WiFi Direct by
...
object UserExitHotspotPolicy {
    ...
    /**
     * @param mode [com.motolink.android.utils.Settings.wifiConnectionMode]
     * @param helperStrategy [HelperStrategy]
     * @param nativeStrategy applies to [WifiLauncherMode.NATIVE] only
     * @param autoEnableHotspot [com.motolink.android.utils.Settings.autoEnableHotspot] — the
