...
import com.motolink.android.aap.AapSslContext
import com.motolink.android.aap.AapTransport
...
import com.motolink.android.aap.protocol.messages.SensorEvent
import com.motolink.android.aap.protocol.proto.MediaPlayback
import java.net.Socket
import android.view.KeyEvent
import com.motolink.android.aap.protocol.messages.TouchEvent
import com.motolink.android.aap.protocol.proto.Input.TouchEvent.PointerAction
import com.motolink.android.connection.projection.AbstractUsbProjectionConnection
import com.motolink.android.connection.projection.ProjectionConnection
import com.motolink.android.connection.projection.LibusbProjectionConnection
import com.motolink.android.connection.projection.SocketProjectionConnection
import com.motolink.android.connection.projection.StandardUsbProjectionConnection
import com.motolink.android.connection.usb.UsbDeviceCompat
import com.motolink.android.connection.wifi.modes.helper.NearbySocket

/**
 * Central connection and transport lifecycle manager.
 *
 * CommManager owns the full lifecycle of both the physical connection ([com.motolink.android.connection.projection.ProjectionConnection])
...
class CommManager(
     ...
     * [com.motolink.android.connection.UnresponsivePeerPolicy].
     *
     ...
     *
     * Called by [com.motolink.android.aap.AapService] in parallel with the
     ...
     * already been called by [com.motolink.android.aap.AapProjectionActivity].
     ...
     * [com.motolink.android.connection.self.SelfLaunchTimeoutPolicy.mayDisconnect].
     */
    ...
    private fun transportedQuited(isClean: Boolean) {
        ...
        if (settings.killOnDisconnect) {
            context.sendBroadcast(android.content.Intent("com.motolink.android.ACTION_FINISH_ACTIVITIES").apply {
                setPackage(context.packageName)
            })
            android.os.Handler(android.os.Looper.getMainLooper()).postDelayed({
                // Stop the foreground service first to remove the notification
                val stopIntent = android.content.Intent(context, com.motolink.android.aap.AapService::class.java).apply {
                    action = com.motolink.android.aap.AapService.ACTION_STOP_SERVICE
                }
                com.motolink.android.aap.AapService.killProcessOnDestroy = true
    ...
    fun sendUpdateUiConfigRequest(left: Int, top: Int, right: Int, bottom: Int) {
        val request = com.motolink.android.aap.protocol.messages.UpdateUiConfigRequest(left, top, right, bottom)
        ...
        send(com.motolink.android.aap.protocol.messages.VideoFocusEvent(gain = true, unsolicited = true))
    }
     ...
     *
     * Two policies decide when this is warranted, and nothing else should: [com.motolink.android.decoder.video.WarmRelaunchKeyframePolicy]
     * for a surface that has never shown a frame, and [com.motolink.android.decoder.video.KeyframeCycleEscalationPolicy] for a picture
    ...
    fun retakeVideoFocusForKeyframe() {
        _transport?.let {
            it.send(com.motolink.android.aap.protocol.messages.VideoFocusEvent(gain = true, unsolicited = true))
            it.endFocusCycle()
        }
    }
    ...
    fun disconnect(
        ...
        byeByeReason: com.motolink.android.aap.protocol.proto.Control.ByeByeReason = com.motolink.android.aap.protocol.proto.Control.ByeByeReason.USER_SELECTION,
