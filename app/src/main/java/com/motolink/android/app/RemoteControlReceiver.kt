...
class RemoteControlReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val debugIntent = Intent("com.motolink.android.DEBUG_KEY").apply {
        ...
        if (Intent.ACTION_MEDIA_BUTTON == action) {
            ...
            event?.let {
                ...
                val keyIntent = Intent(com.motolink.android.contract.KeyIntent.action).apply {
                    putExtra(com.motolink.android.contract.KeyIntent.extraEvent, it)
                    setPackage(context.packageName)
                }
