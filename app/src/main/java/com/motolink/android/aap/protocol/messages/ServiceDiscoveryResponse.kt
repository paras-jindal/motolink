...
import com.motolink.android.aap.VehicleIdentityPolicy
import com.motolink.android.aap.VehicleTypePolicy
import com.motolink.android.input.KeyCode
import com.motolink.android.aap.protocol.AudioConfigs
import com.motolink.android.aap.protocol.Channel
import com.motolink.android.aap.protocol.MicCaptureFormat
    ...
    companion object {
        private fun makeProto(context: Context): Message {
                    ...
                    val explicitSoftwareHevc =
                        settings.videoCodec == VideoDecoder.CodecType.H265.settingsValue &&
                                ...
                                when (settings.softwareVideoDecoder) {
                                    com.motolink.android.utils.Settings.SoftwareVideoDecoder.BUNDLED_FFMPEG ->
                                        com.motolink.android.decoder.video.VideoDecoder.isBundledHevcDecoderAvailable()
                                    com.motolink.android.utils.Settings.SoftwareVideoDecoder.DEVICE_MEDIACODEC ->
                                        com.motolink.android.decoder.video.VideoDecoder.isHevcDecoderAvailable(includeSoftware = true)
                                }
                    val hevcAvailableForUserChoice =
                        com.motolink.android.decoder.video.VideoDecoder.isHevcSupported() || explicitSoftwareHevc
                    val hevcAvailableForHighResolution =
                        com.motolink.android.decoder.video.VideoDecoder.isHevcReliable() || explicitSoftwareHevc
                    ...
                    val codecToRequest = when (settings.videoCodec) {
                        ...
                        "Auto" -> {
                            ...
                            if (negotiatedResolution == Control.Service.MediaSinkService.VideoConfiguration.VideoCodecResolutionType._3840x2160 &&
                                com.motolink.android.decoder.video.VideoDecoder.isHevcReliable()) {
                                Media.MediaCodecType.MEDIA_CODEC_VIDEO_H265
                            } else {
                                Media.MediaCodecType.MEDIA_CODEC_VIDEO_H264_BP
                            }
            ...
            return Control.ServiceDiscoveryResponse.newBuilder().apply {
                ...
                setHeadunitInfo(com.motolink.android.aap.protocol.proto.Common.HeadUnitInfo.newBuilder().apply {
        ...
        private fun logNegotiatedCodecCapability(codec: Media.MediaCodecType, fps: Int) {
            ...
            val capability = com.motolink.android.decoder.video.DecoderCapabilityReport
        ...
        private fun announcedFrameRate(
            context: Context,
            settings: com.motolink.android.utils.Settings
        ): Int = try {
         ...
         */
        private fun logNarrowBandProfile(context: Context, settings: com.motolink.android.utils.Settings) {
            val advice = try {
