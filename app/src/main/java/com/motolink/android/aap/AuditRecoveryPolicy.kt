 ...
 * fragment going missing is invisible everywhere else: [com.motolink.android.decoder.video.VideoFragmentAssembler] still sees a first,
 ...
 *   [com.motolink.android.decoder.video.VideoFragmentAssembler.Anomaly.TRUNCATED_PREVIOUS] and
 *   [com.motolink.android.decoder.video.VideoFragmentAssembler.Anomaly.ORPHANED_FRAGMENT], which already ask. Asking here too would
 *   double-ask for one fault - and, since the ask is also what stamps the corruption clock
 *   [com.motolink.android.decoder.video.KeyframeCycleEscalationPolicy] reads, would make one lost fragment look like a wire that is
 *   still breaking.
 ...
 *
 * Pure: no clock, no logging. Throttling the ask stays with [com.motolink.android.decoder.video.VideoRecoveryPolicy], which every other
