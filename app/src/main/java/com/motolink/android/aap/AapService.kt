...
import com.motolink.android.app.ActivityLaunchPolicy
import com.motolink.android.app.BootCompleteReceiver
import com.motolink.android.app.BootLoopPolicy
import com.motolink.android.app.BtAutoDisconnectArm
import com.motolink.android.app.BtAutoDisconnectPolicy
import com.motolink.android.app.BtAutoStartRearmPolicy
import com.motolink.android.app.ForegroundServiceTypePolicy
import com.motolink.android.app.WifiAutoStartReceiver
import com.motolink.android.connection.wifi.HotspotExitAction
import com.motolink.android.connection.wifi.UsbSessionQuiescePolicy
import com.motolink.android.connection.wifi.WirelessBringUpDeferralPolicy
import com.motolink.android.connection.wifi.UserExitHotspotPolicy
...
import com.motolink.android.utils.DummyVpnPolicy
import com.motolink.android.utils.ToastUtils
import com.motolink.android.aap.protocol.messages.NightModeEvent
import com.motolink.android.aap.protocol.proto.MediaPlayback
import com.motolink.android.decoder.audio.MicRecorder
import com.motolink.android.connection.CommManager
import com.motolink.android.connection.carkey.CarKeysManager
import com.motolink.android.connection.wifi.NetworkDiscovery
...
import com.motolink.android.location.GpsLocationService
import com.motolink.android.utils.LocaleHelper
import com.motolink.android.utils.LogExporter
import com.motolink.android.utils.NightModeManager
...
import com.motolink.android.contract.SessionStateIntent
...
import com.motolink.android.connection.self.SelfModeDisconnectPolicy
import com.motolink.android.connection.usb.UsbLauncherManager
import com.motolink.android.connection.wifi.LinkLossTeardownPolicy
import com.motolink.android.connection.wifi.LinkLossTrigger
...
import com.motolink.android.connection.wifi.modes.nativeaa.ProjectionQrSnapshot
import com.motolink.android.connection.wifi.modes.nativeaa.SessionEndGroupPolicy
import com.motolink.android.utils.HotspotManager
...
import com.motolink.android.connection.wifi.direct.StationScanMonitor
...
import com.motolink.android.connection.wifi.server.WirelessServer
...
import com.motolink.android.utils.protoUint32ToLong
...
class AapService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (intent?.action == ACTION_STOP_SERVICE) {
            ...
            sendBroadcast(Intent("com.motolink.android.ACTION_FINISH_ACTIVITIES").apply {
                setPackage(packageName)
            })
            isDestroying = true
                ...
                serviceScope.launch {
                    if (commManager.isConnected) {
                        ...
                        commManager.disconnect(
                            sendByeBye = true,
                            isUserExit = false,
                            byeByeReason = com.motolink.android.aap.protocol.proto.Control.ByeByeReason.DEVICE_SWITCH,
    ...
    companion object {
        ...
        const val ACTION_START_SELF_MODE           = "com.motolink.android.ACTION_START_SELF_MODE"
        const val ACTION_STOP_SELF_MODE            = "com.motolink.android.ACTION_STOP_SELF_MODE"
        const val ACTION_START_WIRELESS            = "com.motolink.android.ACTION_START_WIRELESS"
        const val ACTION_BT_AUTO_START              = "com.motolink.android.ACTION_BT_AUTO_START"
        const val ACTION_START_WIRELESS_SCAN       = "com.motolink.android.ACTION_START_WIRELESS_SCAN"
        const val ACTION_STOP_WIRELESS             = "com.motolink.android.ACTION_STOP_WIRELESS"
        const val ACTION_ROTATE_WIFI_DIRECT_IDENTITY = "com.motolink.android.ACTION_ROTATE_WIFI_DIRECT_IDENTITY"
        const val ACTION_NATIVE_AA_POKE            = "com.motolink.android.ACTION_NATIVE_AA_POKE"
        const val ACTION_NATIVE_AA_SWITCH_DEVICE   = "com.motolink.android.ACTION_NATIVE_AA_SWITCH_DEVICE"
        const val ACTION_NATIVE_AA_CANCEL_POKE      = "com.motolink.android.ACTION_NATIVE_AA_CANCEL_POKE"
        const val ACTION_NATIVE_AA_PROMPT_SHOWN     = "com.motolink.android.ACTION_NATIVE_AA_PROMPT_SHOWN"
        const val ACTION_NATIVE_AA_PROMPT_DISMISSED = "com.motolink.android.ACTION_NATIVE_AA_PROMPT_DISMISSED"
        const val ACTION_NEARBY_CONNECT             = "com.motolink.android.ACTION_NEARBY_CONNECT"
        const val ACTION_CHECK_USB                 = "com.motolink.android.ACTION_CHECK_USB"
        const val ACTION_STOP_SERVICE              = "com.motolink.android.aap.action.STOP_SERVICE"
        const val ACTION_DISCONNECT                = "com.motolink.android.ACTION_DISCONNECT"
        const val ACTION_REQUEST_NIGHT_MODE_UPDATE = "com.motolink.android.aap.action.REQUEST_NIGHT_MODE_UPDATE"
        const val ACTION_NIGHT_MODE_CHANGED      = "com.motolink.android.ACTION_NIGHT_MODE_CHANGED"
        const val ACTION_ORIENTATION_CHANGED     = "com.motolink.android.ACTION_ORIENTATION_CHANGED"
        const val ACTION_REFRESH_SENSORS         = "com.motolink.android.aap.action.REFRESH_SENSORS"
        const val ACTION_RESTART_AUDIO           = "com.motolink.android.aap.action.RESTART_AUDIO"
        const val ACTION_RAISE_PROJECTION        = "com.motolink.android.aap.action.RAISE_PROJECTION"
        /**
         ...
         */
        const val ACTION_CONNECT_SOCKET            = "com.motolink.android.ACTION_CONNECT_SOCKET"
