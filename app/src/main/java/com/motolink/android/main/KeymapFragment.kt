...
class KeymapFragment : Fragment(), MainActivity.KeyListener {
    ...
    private val keyCodeReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            if (intent.action == "com.motolink.android.DEBUG_KEY") {
                val action = (intent.getStringExtra("action") ?: "unknown").replace("com.motolink.android.", "")
    ...
    override fun onResume() {
        ...
        filter.addAction("com.motolink.android.DEBUG_KEY")
