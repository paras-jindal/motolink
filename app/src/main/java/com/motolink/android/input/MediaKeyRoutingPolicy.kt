 ...
 * focus to deactivate the sink's session is exactly the behaviour [com.motolink.android.decoder.audio.PlaybackFocusPolicy] exists to
...
object MediaKeyRoutingPolicy {
     ...
     *                         [com.motolink.android.decoder.audio.PlaybackFocusPolicy], where an unreadable state means "assume a link
