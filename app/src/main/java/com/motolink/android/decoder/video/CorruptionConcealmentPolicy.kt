...
object CorruptionConcealmentPolicy {
     ...
     * [com.motolink.android.aap.ProjectionWatchdogPolicy.DISPLAY_FREEZE_MS], because a
     ...
     *   to [com.motolink.android.decoder.video.WarmRelaunchKeyframePolicy], not to this.
     */
    fun next(
        nowMs: Long,
        state: State,
