 ...
 * release/regain cycle instead of the gain-only nudge [com.motolink.android.aap.AapTransport] normally sends.
 *
 * ### Why the nudge is not enough
 *
 * The gain-only unsolicited [com.motolink.android.aap.protocol.messages.VideoFocusEvent] is
