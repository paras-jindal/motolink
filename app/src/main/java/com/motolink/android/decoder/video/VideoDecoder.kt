...
class VideoDecoder(
     ...
     * that [com.motolink.android.decoder.video.KeyframeCycleEscalationPolicy] uses to decide whether
     ...
     * [com.motolink.android.decoder.video.WarmRelaunchKeyframePolicy], which must not have a second
