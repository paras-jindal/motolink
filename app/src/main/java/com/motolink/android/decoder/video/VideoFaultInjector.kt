 ...
 * [com.motolink.android.aap.FragmentedMessageAudit]** - that check runs in the readers, on the header, before decryption
...
class VideoFaultInjector(private val mode: Mode, rate: Int, budget: Int = UNLIMITED_BUDGET) {
    ...
    enum class Mode(val value: Int, val stage: Stage) {
         ...
         *
         * **Nothing reports it, and that is the point of keeping this mode.** [com.motolink.android.aap.FragmentedMessageAudit]
         ...
         * so [com.motolink.android.aap.FragmentedMessageAudit] sees a delta no fragment count explains and reports
