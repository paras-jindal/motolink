...
import com.motolink.android.aap.FragmentedMessageAudit.Outcome
 ...
 *
 * A missing *middle* fragment leaves the run looking intact to [com.motolink.android.decoder.video.VideoFragmentAssembler] - first,
